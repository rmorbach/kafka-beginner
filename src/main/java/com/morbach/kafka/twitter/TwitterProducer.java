...
public class TwitterProducer {
		...
		while(!client.isDone()) {
			try {
				...
				if (message != null) {
					...
					ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>("twitter_tweets", message);
	...
	public Client createTwitterClient(BlockingQueue<String> msgQueue) {
		...
		Authentication hosebirdAuth = new OAuth1(TWITTER_CONSUMER_KEY,
				TWITTER_CONSUMER_TOKEN,
				TWITTER_API_KEY, TWITTER_API_TOKEN);
